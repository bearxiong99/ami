  ...
  <div class="lock-container">
    <div class="lock-form animated bounceInDown">
      <div class="animated"
        ...
        <el-input :maxlength="30" :placeholder="$t('global.enterPassword')"
                  type="password"
...
<script>
  ...
  export default {
    ...
    methods: {
      handleLogout() {
        this.$confirm(this.$t('lock.confirmLogout'), this.$t('lock.confirmLogout'), {
      ...
      handleLogin() {
        if (this.passwd != this.lockPasswd) {
          this.passwd = "";
          this.$message({
            message: this.$t('lock.wrongPassword'),
            type: "error"
          });
