import {setToken, removeToken, setRefreshToken, removeRefreshToken} from '@/util/auth'
  ...
  actions: {
    ...
    LoginByUsername({commit}, userInfo) {
      ...
      return new Promise((resolve, reject) => {
        ...
        loginByUsername(userInfo.tenantId, userInfo.username, userInfo.password, userInfo.type, userInfo.uuid, userInfo.captcha).then(res => {
