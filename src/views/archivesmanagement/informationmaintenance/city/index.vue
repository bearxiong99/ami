      ...
      <div class="cityright">
        <el-form
          ...
          <el-form-item :label="$t('areaManage.name')" prop="disc">
            <el-input v-model="formCity.disc" size="small" :maxlength="100"></el-input>
          </el-form-item>
        </el-form>
      </div>
    ...
    operate (val) {
      if (!val) {
        if (this.selectCityData.length === 0) {
          ...
          this.formCity.disc = this.selectCityData[0].orgName
        }
      }
      this.flag = val
