    ...
    data() {
      return {
        ...
        option: {
          ...
          column: [
            {
              label: this.$t('param.paramName'),
              prop: "paramName",
              search: true,
              rules: [{
                required: true,
                message: this.$t('param.enterParamName'),
                trigger: "blur"
              }]
            },
            {
              label: this.$t('param.paramKey'),
              prop: "paramKey",
              search: true,
              rules: [{
                required: true,
                message: this.$t('param.enterParamKey'),
                trigger: "blur"
              }]
            },
            {
              label: this.$t('param.paramValue'),
              prop: "paramValue",
              rules: [{
                required: true,
                message: this.$t('param.enterParamValue'),
                trigger: "blur"
              }]
            }
          ]
