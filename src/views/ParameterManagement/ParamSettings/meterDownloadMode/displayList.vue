  ...
  <div>
    ...
    <el-dialog
      ...
      <el-tabs v-model="active">
        <el-tab-pane :label="$t('param.normal')" name="1">
          <el-transfer v-model="val" :data="data"></el-transfer>
        </el-tab-pane>
        <el-tab-pane :label="$t('param.test')" name="2">
        </el-tab-pane>
      </el-tabs>
      <div slot="footer" class="dialog-footer" style="text-align:right;">
        <el-button @click="dialogShow = false" size="small">{{$t('global.cancel')}}</el-button>
        <el-button type="primary" size="small">{{$t('auto.confirm')}}</el-button>
      </div>
    </el-dialog>
