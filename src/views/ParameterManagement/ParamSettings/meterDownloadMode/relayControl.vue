    ...
    <div class="select">
      ...
      <el-checkbox-group v-model="checked" @change="check" class="group">
        <el-checkbox :label="1">
          ...
          <el-select v-model="params.value1" style="width:500px">
            <el-option
        ...
        <el-checkbox :label="2">
          <span>Selection of the input control signals</span>
          <el-select v-model="params.value2" style="width:500px">
            <el-option
        ...
        <el-checkbox :label="3">
          <span>Auto recovery times setting of current over limit</span>
          <el-input v-model="params.value3" style="width:200px"></el-input>
        </el-checkbox>
      </el-checkbox-group>
    </div>
...
export default {
  ...
  data () {
    return {
      ...
      powerList: [
        {
          disc:"Mode 0 None The disconnect control object is always in 'connected' state",
          code: 0
        },
        {
      ...
      controlList:[
        {
          disc:"Disable all(Remotely, Manually, Locally & Current over limit threshold)",
          code: 0
        },
        {
          disc: "Current over limit threshold only",
          code: 1
        },
        {
          disc: "Remote and manual only",
          code: 2
        },
        {
          disc: "Enable all(Remotely, Manually, Locally and Current over limit threshold)",
          code: 3
        },
        {
          disc: "Reserved",
